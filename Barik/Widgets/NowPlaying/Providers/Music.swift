...
@objc public enum MusicEKnd: AEKeyword {
	case trackListing = 0x6b54_726b /* b'kTrk' */
	case albumListing = 0x6b41_6c62 /* b'kAlb' */
	case cdInsert = 0x6b43_4469 /* b'kCDi' */
}

// MARK: MusicEnum
@objc public enum MusicEnum: AEKeyword {
	case standard = 0x6c77_7374 /* b'lwst' */
	case detailed = 0x6c77_6474 /* b'lwdt' */
}
...
@objc public enum MusicERpt: AEKeyword {
	case off = 0x6b52_704f /* b'kRpO' */
	case one = 0x6b52_7031 /* b'kRp1' */
	case all = 0x6b41_6c6c /* b'kAll' */
}

// MARK: MusicEShM
@objc public enum MusicEShM: AEKeyword {
	case songs = 0x6b53_6853 /* b'kShS' */
	case albums = 0x6b53_6841 /* b'kShA' */
	case groupings = 0x6b53_6847 /* b'kShG' */
}

// MARK: MusicESrc
@objc public enum MusicESrc: AEKeyword {
	case library = 0x6b4c_6962 /* b'kLib' */
	case audioCD = 0x6b41_4344 /* b'kACD' */
	case mp3CD = 0x6b4d_4344 /* b'kMCD' */
	case radioTuner = 0x6b54_756e /* b'kTun' */
	case sharedLibrary = 0x6b53_6864 /* b'kShd' */
	case iTunesStore = 0x6b49_5453 /* b'kITS' */
	case unknown = 0x6b55_6e6b /* b'kUnk' */
}

// MARK: MusicESrA
@objc public enum MusicESrA: AEKeyword {
	case albums = 0x6b53_724c /* b'kSrL' */
	case all = 0x6b41_6c6c /* b'kAll' */
	case artists = 0x6b53_7252 /* b'kSrR' */
	case composers = 0x6b53_7243 /* b'kSrC' */
	case displayed = 0x6b53_7256 /* b'kSrV' */
	case names = 0x6b53_7253 /* b'kSrS' */
}

// MARK: MusicESpK
@objc public enum MusicESpK: AEKeyword {
	case none = 0x6b4e_6f6e /* b'kNon' */
	case folder = 0x6b53_7046 /* b'kSpF' */
	case genius = 0x6b53_7047 /* b'kSpG' */
	case library = 0x6b53_704c /* b'kSpL' */
	case music = 0x6b53_705a /* b'kSpZ' */
	case purchasedMusic = 0x6b53_704d /* b'kSpM' */
}

// MARK: MusicEMdK
@objc public enum MusicEMdK: AEKeyword {
	case song = 0x6b4d_6453 /* b'kMdS' */
	case musicVideo = 0x6b56_6456 /* b'kVdV' */
	case movie = 0x6b56_644d /* b'kVdM' */
	case tvShow = 0x6b56_6454 /* b'kVdT' */
	case unknown = 0x6b55_6e6b /* b'kUnk' */
}

// MARK: MusicERtK
@objc public enum MusicERtK: AEKeyword {
	case user = 0x6b52_7455 /* b'kRtU' */
	case computed = 0x6b52_7443 /* b'kRtC' */
}

// MARK: MusicEAPD
@objc public enum MusicEAPD: AEKeyword {
	case computer = 0x6b41_5043 /* b'kAPC' */
	case airPortExpress = 0x6b41_5058 /* b'kAPX' */
	case appleTV = 0x6b41_5054 /* b'kAPT' */
	case airPlayDevice = 0x6b41_504f /* b'kAPO' */
	case bluetoothDevice = 0x6b41_5042 /* b'kAPB' */
	case homePod = 0x6b41_5048 /* b'kAPH' */
	case tv = 0x6b41_5056 /* b'kAPV' */
	case unknown = 0x6b41_5055 /* b'kAPU' */
}

// MARK: MusicEClS
@objc public enum MusicEClS: AEKeyword {
	case unknown = 0x6b55_6e6b /* b'kUnk' */
	case purchased = 0x6b50_7572 /* b'kPur' */
	case matched = 0x6b4d_6174 /* b'kMat' */
	case uploaded = 0x6b55_706c /* b'kUpl' */
	case ineligible = 0x6b52_656a /* b'kRej' */
	case removed = 0x6b52_656d /* b'kRem' */
	case error = 0x6b45_7272 /* b'kErr' */
	case duplicate = 0x6b44_7570 /* b'kDup' */
	case subscription = 0x6b53_7562 /* b'kSub' */
	case prerelease = 0x6b50_7252 /* b'kPrR' */
	case noLongerAvailable = 0x6b52_6576 /* b'kRev' */
	case notUploaded = 0x6b55_7050 /* b'kUpP' */
}

// MARK: MusicEExF
@objc public enum MusicEExF: AEKeyword {
	case plainText = 0x6b54_5854 /* b'kTXT' */
	case unicodeText = 0x6b55_4354 /* b'kUCT' */
	case xml = 0x6b58_4d4c /* b'kXML' */
	case m3U = 0x6b4d_3355 /* b'kM3U' */
	case m3U8 = 0x6b4d_3338 /* b'kM38' */
}

// MARK: MusicGenericMethods
@objc public protocol MusicGenericMethods {
	@objc optional func printPrintDialog(
		_ printDialog: Bool,
		withProperties: [AnyHashable: Any]!,
		kind: MusicEKnd,
		theme: String!
...
@objc public protocol MusicApplication: SBApplicationProtocol, SBMusicApplicationProtocol {
