...
struct SystemBannerWidget: View {
	...
	var body: some View {
		...
		}.onReceive(NotificationCenter.default.publisher(for: Notification.Name("ShowWhatsNewBanner")))
		{ _ in
			withAnimation {
				showWhatsNew = true
			}
		}.onReceive(NotificationCenter.default.publisher(for: Notification.Name("HideWhatsNewBanner")))
		{ _ in
			withAnimation {
				showWhatsNew = false
			}
